Contributing to LazySloth Core
============================

The LazySloth Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the LazySloth Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/lazysloth-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to lazysloth-qt
...
The following applies to code changes to the LazySloth Core project (and related
projects such as libsecp256k1), and is not to be confused with overall LazySloth
Network Protocol consensus changes.

Whether a pull request is merged into LazySloth Core rests with the project merge
...
Patches that change LazySloth consensus rules are considerably more involved than
...
Where a patch set proposes to change the LazySloth consensus, it must have been
...
The project leader is the release manager for each LazySloth Core release.
