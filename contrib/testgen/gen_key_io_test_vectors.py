...
bech32_templates = [
  ...
  ('lzsl',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lzsl',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lzsl',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('lzsl',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tlzsl',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlzsl',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlzsl',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlzsl',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tlzsl',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlzsl',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlzsl',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlzsl',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rlzsl',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rlzsl',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rlzsl',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rlzsl', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tlzsl',   17, 32, Encoding.BECH32M, False, False, False),
  ('rlzsl',  3,  1, Encoding.BECH32M, False, False, False),
  ('lzsl',   15, 41, Encoding.BECH32M, False, False, False),
  ('tlzsl',    0, 16, Encoding.BECH32,  False, False, False),
  ('rlzsl',  0, 32, Encoding.BECH32,  True,  False, False),
  ('lzsl',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tlzsl',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rlzsl',  0, 20, Encoding.BECH32,  False, False, True),
  ('lzsl',    0, 20, Encoding.BECH32M, False, False, False),
  ('tlzsl',    0, 32, Encoding.BECH32M, False, False, False),
  ('rlzsl',  0, 20, Encoding.BECH32M, False, False, False),
  ('lzsl',    1, 32, Encoding.BECH32,  False, False, False),
  ('tlzsl',    2, 16, Encoding.BECH32,  False, False, False),
  ('rlzsl', 16, 20, Encoding.BECH32,  False, False, False),
]
