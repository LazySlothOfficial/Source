# Support for Output Descriptors in LazySloth Core

Since LazySloth Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `lzsl1...` for mainnet or `tlzsl1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing LazySloth Core wallets, a convenience function `combo` is
