# Fuzzing LazySloth Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing LazySloth Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the LazySloth Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make LazySloth Core more robust.
...
with certain assembly code from LazySloth Core's code. See [developer notes on sanitizers](/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing LazySloth Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing LazySloth Core using [`afl-fuzz`](https://github.com/google/afl):
