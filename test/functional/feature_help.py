...
"""Verify that starting lazysloth with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lazysloth with -h for help text")
        ...
        self.log.info("Start lazysloth with -version for version information")
        ...
        self.log.info("Start lazyslothd with -fakearg to make sure it does not start")
